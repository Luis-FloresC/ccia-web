            ...
            <ScrollPanel style={{ width: '100%', height: '450px' }}>
                ...
                <div className="text-sm text-black">
                    ...
                    <p className="text-start">
                        <span className="fw-bold">Artículo 30.</span> Toda persona natural o jurídica que se dedique a ejercer el comercio, que se haya declarado como comerciante individual o constituido como sociedades mercantiles, deberán estar inscrito en la Cámara de su domicilio, de conformidad con el art. 384 del código de Comercio. Igual Obligación tendrán las sociedades extranjeras, autorizadas para operar en Honduras.
                    </p>
                ...
                <div className="text-black">
                    ...
                    <p className="text-start ">
                        ...
                        La Secretaria de Estado en los Despachos de Industria y Comercio, previa notificación de la Cámara, impondrá al comerciante una multa equivalente hasta de diez (10) veces el valor de la cuota de inscripción que debe cubrir cuando este, estando obligado a registrase en la Cámara respectiva, no lo efectué dentro de los tres meses (3), después de la fecha de su inscripción en el Registro Mercantil.
                    </p>
                    <br />
                    <ul className="list-group">
                        <li className="list-group-item fw-bold">Los registros se renovaran obligatoriamente todos los años terminados en cero (0) y en cinco (5).</li>
                    </ul>
                    <br />
                    <p className="text-start">
