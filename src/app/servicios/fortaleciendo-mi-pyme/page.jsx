            ...
            <HeroeSinFoto
                ...
                <dic className="row">
                    <div className="col-md-12">
                        <HeroeSinFoto
                            title={"Módulos"}
                            content={"Fortalecimiento Mi Pyme"}
                        />
                    </div>
                    <div className="col-md-12">
                        <div className="row">
                            <div className="col-4">
                                <div className="list-group" id="list-tab" role="tablist">
                                    <a className="list-group-item list-group-item-action active" id="list-home-list" data-bs-toggle="list" href="#list-modulo-0" role="tab" aria-controls="list-home">Introducción de un Negocio Consciente y Cuál es Mi Potencial como Emprendedor</a>
                                    <a className="list-group-item list-group-item-action" id="list-profile-list" data-bs-toggle="list" href="#list-modulo-1" role="tab" aria-controls="list-profile">¿Por Qué Existe Mi Negocio?</a>
                                    <a className="list-group-item list-group-item-action" id="list-messages-list" data-bs-toggle="list" href="#list-modulo-2" role="tab" aria-controls="list-messages">¿A Quién le Vendo?</a>
                                    <a className="list-group-item list-group-item-action" id="list-settings-list" data-bs-toggle="list" href="#list-modulo-3" role="tab" aria-controls="list-settings">¿Quién Más Vende?</a>
                                    <a className="list-group-item list-group-item-action" id="list-home-list" data-bs-toggle="list" href="#list-modulo-4" role="tab" aria-controls="list-home">¿Qué Vendo?</a>
                                    <a className="list-group-item list-group-item-action" id="list-profile-list" data-bs-toggle="list" href="#list-modulo-5" role="tab" aria-controls="list-profile">¿Cómo Vendo?</a>
                                    <a className="list-group-item list-group-item-action" id="list-messages-list" data-bs-toggle="list" href="#list-modulo-6" role="tab" aria-controls="list-messages">¿Cuánto Gasto?</a>
                                    <a className="list-group-item list-group-item-action" id="list-settings-list" data-bs-toggle="list" href="#list-modulo-7" role="tab" aria-controls="list-settings">¿Cuándo Alcanzaré las Metas?</a>
                                    <a className="list-group-item list-group-item-action" id="list-settings-list" data-bs-toggle="list" href="#list-modulo-8" role="tab" aria-controls="list-settings">¿Qué Impacto Genero?</a>
                                </div>
                            </div>
                            <div className="col-8">
                                <div className="tab-content" id="nav-tabContent">
                                    <div className="tab-pane fade show active" id="list-modulo-0" role="tabpanel" aria-labelledby="list-home-list">
